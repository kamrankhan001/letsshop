...
<div class="flex justify-between">
        ...
        <div>
            <ul>
                <li class="hover:bg-gray-700 p-2">
                    <a href="{{route('babies')}}" class="">Babies</a>
                </li>
                <li class="hover:bg-gray-700 p-2">
                    <a href="{{route('boys')}}" class="">Boys</a>
                </li>
                <li class="hover:bg-gray-700 p-2">
                    <a href="{{route('girls')}}" class="">Girls</a>
                </li>         
            </ul>
        </div>
    </aside>
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
        <h1 class="text-3xl container mx-auto text-center pt-2">Kids</h1>
