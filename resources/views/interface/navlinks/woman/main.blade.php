...
<div class="flex justify-between">
        ...
        <div>
            <ul>
                <li class="hover:bg-gray-700 p-2">
                    <a href="{{route('jeans')}}" class="">Jeans</a>
                </li>
                <li class="hover:bg-gray-700 p-2">
                    <a href="{{route('tees')}}" class="">Tees</a>
                </li>
                <li class="hover:bg-gray-700 p-2">
                    <a href="{{route('beauty')}}" class="">Beauty</a>
                </li><hr>
            </ul>
        </div>
    </aside>
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
        <h1 class="text-3xl container mx-auto text-center pt-2">Women</h1>
